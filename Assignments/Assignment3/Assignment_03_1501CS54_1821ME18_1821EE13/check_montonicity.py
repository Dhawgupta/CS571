...
print("Fir h3")
timeh3 = time.time()
objh3 = run_experiment_check_montonicity(start_state = state, goal_state = goal, h_function=h3)
timeh3 = time.time() - timeh3
print("Fpor H2")
timeh2 = time.time()
objh2 = run_experiment_check_montonicity(start_state = state, goal_state = goal, h_function=h2)
