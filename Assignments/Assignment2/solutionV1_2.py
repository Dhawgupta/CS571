...
def h3(current, goal, current_hash = None, goal_hash = None):
	...
	# print(current)
	# print(goal)
	# print("Current State :{}".format(current_hash))
	# print("Goal Hash : {}".format(goal_hash))
...
ost/Iter : 2000
Success Found Path
[dhawal.cs15@cseresearch Assignment2]$ python solutionV1_2.py
{0.0: [2, 2], 1.0: [0, 0], 2.0: [0, 1], 3.0: [0, 2], 4.0: [1, 0], 5.0: [1, 1], 6.0: [1, 2], 7.0: [2, 0], 8.0: [2, 1]}
True
The start state :
[[4 2 6]
 [3 8 1]
